  ...
  const handleQuickDemo = async () => {
    ...
    try {
      ...
      try {
        ...
        handleFirestoreError(error, OperationType.CREATE, `users/${uid}/documents`);
        return;
      }
      ...
      try {
        ...
        handleFirestoreError(error, OperationType.CREATE, `users/${uid}/applications`);
        return;
      }
        ...
        <div className="glass-panel rounded-3xl p-8 border border-white/10 shadow-2xl">
          ...
          <form onSubmit={authState === 'login' ? handleLogin : handleSignup} className="space-y-5">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-gray-500 text-xs font-bold uppercase tracking-wider">Or</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white text-black hover:bg-gray-200 font-black py-4 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70"
            >
